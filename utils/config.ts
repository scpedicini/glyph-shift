 ...
 * Set LOGGING_DISABLED to true to disable all logging
 */
export const EXTENSION_CONFIG = {
  ...
  FORCE_LOGS_IN_PROD: false, // Set to true to enable logging in production builds since it is disabled by default
};